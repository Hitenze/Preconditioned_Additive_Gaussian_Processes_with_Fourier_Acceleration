function [kernel] = gaussianKernel(X, f, l, mu, params, require_grad, form_matrix)
%% [kernel] = gaussianKernel(X, f, l, mu, params, require_grad, form_matrix)
...
%           Create kernel matrix with derivative
   ...
   if(nargin < 4 || nargin > 7)
      ...
      kernel.l = 1.0;
      kernel.mu = 0.01;
      kernel.kernelfunc = @nfftgp.kernels.kernels.gaussianKernelMat;
      kernel.params = {};
