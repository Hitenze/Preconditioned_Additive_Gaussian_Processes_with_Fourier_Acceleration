...
int main(int argc, char **argv)
{
   ...
   pnfft4gp_kernel additivekernel_data_l = kernel == 0 ? (pnfft4gp_kernel)Nfft4GPKernelAdditiveKernelParamCreate( data_all, n1+n2, n1+n2, d,
                                             windows, nwindows, dwindows, &Nfft4GPKernelGaussianKernel) :
                                             (pnfft4gp_kernel)Nfft4GPKernelAdditiveKernelParamCreate( data_all, n1+n2, n1+n2, d,
                                             windows, nwindows, dwindows, &Nfft4GPKernelMatern12Kernel);
   ...
   sprintf(outfile_name, "%s_%d_additive.txt", data_name, kernel);
   ...
   sprintf(lossoutfile_name, "%s_%d_loss_additive.txt", data_name, kernel);
   ...
   Nfft4GPKernelParamFree(additivekernel_data_l);
   free(data_name);
